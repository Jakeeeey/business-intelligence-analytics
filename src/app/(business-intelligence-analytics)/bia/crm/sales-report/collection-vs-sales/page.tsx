...
import CollectionVsSalesModule from "@/modules/business-intelligence-analytics/crm/sales-report/collection-vs-sales";
...
export default async function CollectionVsSalesPage() {
