...
function roleBadge(role: AllocationLogRow["creatorRole"]) {
  if (role === "Executive") return <Badge variant="outline" className="border-blue-200 text-blue-700">Executive</Badge>;
  return <Badge variant="outline" className="border-purple-200 text-purple-700">Div Manager</Badge>;
}
