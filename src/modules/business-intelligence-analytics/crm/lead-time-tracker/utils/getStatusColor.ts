...
export const getStatusColor = (status?: string | null): string => {
  ...
  if (s === "warning" || s === "warn")
    return "bg-orange-300/70 text-orange-900 dark:bg-orange-900/30 dark:text-orange-100";
  if (s === "delayed" || s === "delay" || s === "late")
    return "bg-red-400/80 text-red-900 dark:bg-red-900/30 dark:text-red-100";
